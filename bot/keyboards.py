...
def main_menu(is_admin: bool = False) -> InlineKeyboardMarkup:
    ...
    """
    buttons = [
        [InlineKeyboardButton(text="Диджитал Санта (с поздравлениями)", callback_data="start_route1")],
        [InlineKeyboardButton(text="Тайный Санта (с подарками)", callback_data="start_route2")],
    ]
...
def admin_menu() -> InlineKeyboardMarkup:
    ...
    buttons = [
        [InlineKeyboardButton(text="Розыгрыш: Диджитал Санта (с поздравлениями)", callback_data="admin_draw_r1")],
        [InlineKeyboardButton(text="Розыгрыш: Тайный Санта (с подарками)", callback_data="admin_draw_r2")],
        [InlineKeyboardButton(text="Уведомить: Диджитал Санта (с поздравлениями)", callback_data="admin_notify_r1")],
        [InlineKeyboardButton(text="Уведомить: Тайный Санта (с подарками)", callback_data="admin_notify_r2")],
